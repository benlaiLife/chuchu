	...
	angular.module("payModule", ['ui.router'])
		...
		.controller('payCtrl', ['$scope', '$http', function($scope, $http) {
			...
			$scope.showBox=function() {
				$scope.addresInfo=true;
			}
			$scope.confirm=function () {
				$scope.info=$scope.citieName+$scope.townName+$scope.areaName+$scope.payAddes+$scope.payName+$scope.payName+$scope.payPhone;
				$scope.addresInfo=false;
			}
			//城市数据
